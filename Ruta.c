...
/**
*@file   Ruta.c
*@brief  Espacio para las funciones del código.
*/
...
*@param     fc       Variable para el número de filas y columnas la cual almacena la misma cantidad.
*\return    void.
*/
...
*\details   Imprime la matriz en formato de tabla.
*@param     m       Variable para la matriz.
*@param     fc       Variable para el número de filas y columnas.
*\return    void.
*/
...
/**
*@brief   Se solicitan las adyacencias del problema.
...
void introducir_adya(int g[][2],int m[][TAM],int f){
	int i,x,y;
	for(i=0;i<f;i++){	
	printf("\n.....Cuales son las coordenadas de adyacencia %d.....\n",i+1);
	printf("Introduce x: ");
	scanf("%d", &x);
	printf("Introduce y: ");
	scanf("%d", &y);
...
*\details Notar como en la sección de return dentro de los valores de la función "buscar" en vez de usar "a" se usa "d" para poder usar correctamente la recursividad.
*@param   g     Variable para la matriz auxiliar.
*@param   m     Variable para la matriz.
